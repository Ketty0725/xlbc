<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="药品id" align="center" prop="id" v-if="true"/>
      ...
      <el-table-column label="药品简介" align="center" prop="info" :show-overflow-tooltip="true" />
      <el-table-column label="封面" align="center" prop="oss" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.oss.url" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="药品简介" prop="info">
          <el-input v-model="form.info" placeholder="请输入药品简介" />
        </el-form-item>
...
import { listProductcategory } from "@/api/app/productcategory";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('app/product/export', {
        ...this.queryParams
