...
import com.ketty.chinesemedicine.databinding.FragmentCollectWithNoteBinding;
...
public class CollectWithNoteFragment extends RxFragment {
    private FragmentCollectWithNoteBinding bind;
    private CommunityAdapter mAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        bind = FragmentCollectWithNoteBinding.inflate(inflater, container, false);
    ...
    private void initRequest() {
        ...
        RetrofitManager
                .getInstance()
                .getApiService()
                .postMethod("/community/getBeCollectList", map)
