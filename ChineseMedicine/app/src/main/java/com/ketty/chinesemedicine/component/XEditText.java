...
public class XEditText extends AppCompatEditText {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mClearResId = a.getResourceId(R.styleable.XEditText_x_clearDrawable, R.drawable.x_et_svg_ic_clear);
        togglePwdDrawableEnable = a.getBoolean(R.styleable.XEditText_x_togglePwdDrawableEnable, true);
        mShowPwdResId = a.getResourceId(R.styleable.XEditText_x_showPwdDrawable, R.drawable.x_et_svg_ic_show_password);
        mHidePwdResId = a.getResourceId(R.styleable.XEditText_x_hidePwdDrawable, R.drawable.x_et_svg_ic_hide_password);
        ...
        if (mShowPwdResId == R.drawable.x_et_svg_ic_show_password &&
                mHidePwdResId == R.drawable.x_et_svg_ic_hide_password) {
