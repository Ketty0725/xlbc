...
import com.ketty.chinesemedicine.databinding.ActivityChinesePatentMedicineBinding;
import com.ketty.chinesemedicine.entity.Chinesepatentmedicine;
...
public class ChinesePatentMedicineActivity extends BaseActivity implements View.OnClickListener {
    private ActivityChinesePatentMedicineBinding bind;
    private String title;

    @Override
    protected View initLayout() {
        bind = ActivityChinesePatentMedicineBinding.inflate(getLayoutInflater());
    ...
    private void initData(Chinesepatentmedicine chinesepatentmedicine) {
        setText(bind.tvPrescription,chinesepatentmedicine.getPrescription());
        setText(bind.tvPreparationMethod,chinesepatentmedicine.getPreparationMethod());
        setText(bind.tvAttending,chinesepatentmedicine.getAttending());
        setText(bind.tvCharacters,chinesepatentmedicine.getCharacters());
        setText(bind.tvUsageAndDosage,chinesepatentmedicine.getUsageAndDosage());
        setText(bind.tvNotes,chinesepatentmedicine.getNotes());
        setText(bind.tvSpecification,chinesepatentmedicine.getSpecification());
        setText(bind.tvStoreUp,chinesepatentmedicine.getStoreUp());
    }
        ...
        return new TextColorSizeHelper.SpanInfo(
                ...
                new ClickableSpan() {
                    ...
                    public void onClick(@NonNull View widget) {
                        ...
                        int yAxisTop = bound.top - DisplayUtil.dip2px(ChinesePatentMedicineActivity.this,10);
    ...
    private void startActivity(String title, Class<?> cls) {
        Intent intent = new Intent(ChinesePatentMedicineActivity.this, cls);
        Bundle bundle = new Bundle();
        bundle.putString("title", title);
    ...
    private void initRequest(String title) {
        ...
        RetrofitManager
                .getInstance()
                .getApiService()
                .postMethod("/chinesepatentmedicine/getByName", map)
                ...
                .subscribe(new BaseObserver() {
                    ...
                    public void onSuccess(Map<String, Object> response) {
                        ...
                        Chinesepatentmedicine chinesepatentmedicine = JsonHelper.parserJson2Object(data,
                                Chinesepatentmedicine.class);
                        initData(chinesepatentmedicine);
