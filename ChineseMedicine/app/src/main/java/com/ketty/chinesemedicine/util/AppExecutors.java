...
public class AppExecutors {
    ...
    private static ExecutorService networkExecutor() {
        return new ThreadPoolExecutor(3, 6, 1000, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>(6), r -> new Thread(r, "network_executor"), (r, executor) -> LogUtils.e(TAG, "rejectedExecution: network executor queue overflow"));
    }
