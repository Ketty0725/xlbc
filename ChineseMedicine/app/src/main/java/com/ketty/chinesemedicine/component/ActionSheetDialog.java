...
public class ActionSheetDialog {
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (size == 1) {
                textView.setBackgroundResource(R.drawable.actionsheet_all_selector);
            } else {
                if (i == 1) {
            ...
            if (i < size) {
                ...
                view.setBackgroundColor(android.graphics.Color.parseColor("#000000"));
